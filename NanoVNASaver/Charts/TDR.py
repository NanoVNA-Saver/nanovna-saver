    ...
    def paintEvent(self, _: QtGui.QPaintEvent) -> None:
        ...
        if len(self.tdrWindow.td) > 0:
            ...
            for i in range(y_ticks):
                ...
                qp.setPen(Defaults.cfg.chart_colors.foreground)
            ...
            for i in range(min_index, max_index):
                ...
                if self.isPlotable(x, y):
                    pen.setColor(Defaults.cfg.chart_colors.sweep)
                    qp.setPen(pen)
                    qp.drawPoint(x, y)
                ...
                if self.isPlotable(x, y):
                    pen.setColor(Defaults.cfg.chart_colors.sweep_secondary)
                    qp.setPen(pen)
                    qp.drawPoint(x, y)
        ...
        if self.dragbox.state and self.dragbox.pos[0] != -1:
            dashed_pen = QtGui.QPen(Defaults.cfg.chart_colors.foreground, 1, QtCore.Qt.DashLine)
