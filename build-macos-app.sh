...
pyinstaller --onedir -p src -n NanoVNASaver nanovna-saver.py --recursive-copy-metadata NanoVNASaver --window --clean  -y -i icon_48x48.icns --recursive-copy-metadata NanoVNASaver
